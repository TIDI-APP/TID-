 ...
 * @extends Resource
 */
var WidgetToken = /*#__PURE__*/function (_Resource) {
  _inherits(WidgetToken, _Resource);

  var _super = _createSuper(WidgetToken);

  function WidgetToken() {
    var _this;

    _classCallCheck(this, WidgetToken);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                scopes = scopes || 'read_institutions,write_links';
                _context.next = 7;
