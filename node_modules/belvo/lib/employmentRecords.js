 ...
 * @extends Resource
 */
var EmploymentRecord = /*#__PURE__*/function (_Resource) {
  _inherits(EmploymentRecord, _Resource);

  var _super = _createSuper(EmploymentRecord);

  function EmploymentRecord() {
    var _this;

    _classCallCheck(this, EmploymentRecord);
    ...
    Object.defineProperty(_assertThisInitialized(_this), _endpoint, {
      writable: true,
      value: 'api/employment-records/'
    });
    return _this;
  }

  _createClass(EmploymentRecord, [{
    key: "retrieve",
    value:
    /**
    ...
    */
    function () {
      var _retrieve = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(link) {
        var options,
            saveData,
            attachPDF,
            data,
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                saveData = options.saveData, attachPDF = options.attachPDF;
                data = {
                  link: link,
                  save_data: saveData,
