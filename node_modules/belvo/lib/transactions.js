 ...
 * @extends Resource
 */
var Transaction = /*#__PURE__*/function (_Resource) {
  _inherits(Transaction, _Resource);
  ...
  _createClass(Transaction, [{
     ...
     */
    function () {
      var _retrieve = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(link, dateFrom) {
        var options,
            token,
            saveData,
            account,
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                token = options.token, saveData = options.saveData, account = options.account;
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _ref = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : {}, _ref$limit = _ref.limit, limit = _ref$limit === void 0 ? 100 : _ref$limit, _ref$filters = _ref.filters, filters = _ref$filters === void 0 ? {} : _ref$filters;
                ...
                throw new _exceptions["default"](400, 'Link filter is required');
