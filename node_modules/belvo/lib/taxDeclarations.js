 ...
 * @extends Resource
 */
var TaxDeclaration = /*#__PURE__*/function (_Resource) {
  _inherits(TaxDeclaration, _Resource);

  var _super = _createSuper(TaxDeclaration);

  function TaxDeclaration() {
    var _this;

    _classCallCheck(this, TaxDeclaration);
    ...
    Object.defineProperty(_assertThisInitialized(_this), _endpoint, {
      writable: true,
      value: 'api/tax-declarations/'
    });
    return _this;
  }

  _createClass(TaxDeclaration, [{
    key: "retrieve",
    value:
    /**
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                token = options.token, saveData = options.saveData, attachPDF = options.attachPDF;
                data = {
                  link: link,
                  token: token,
                  year_from: yearFrom,
